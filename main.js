	...
	for (var i = 0; i < 4; i++) {
		for (var j = 0; j < 4; j++) {
			...
			if(board[i][j] == 0){
				...
				theNumberCell.css('top',getPosTop(i,j) + cellSlideWidth/2);
				theNumberCell.css('left',getPosLeft(i,j) + cellSlideWidth/2);
			}else{
				theNumberCell.css('width',cellSlideWidth);
				theNumberCell.css('height',cellSlideWidth);
